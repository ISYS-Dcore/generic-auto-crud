 ...
 * <p>
 * For record‑based DTOs, use {@link RestIntegrationDtoTests} instead.
 *
...
public abstract class RestIntegrationTestsImpl<T extends GenericEntity<String>, K>
     ...
     */
    protected RestIntegrationTestsImpl(String endpoint, T entityTemplate) {
