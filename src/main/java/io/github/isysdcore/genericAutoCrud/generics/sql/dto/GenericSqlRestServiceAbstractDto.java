...
import io.github.isysdcore.genericAutoCrud.generics.sql.GenericSqlRepository;
 ...
 */
public abstract class GenericSqlRestServiceAbstractDto<
        ...
        ID extends Serializable> implements GenericRestServiceDto<DTO, ID> {

    @Autowired
    public REPOSITORY repository;
    protected MAPPER mapper;

    public GenericSqlRestServiceAbstractDto(MAPPER mapper) {
        this.mapper = mapper;
    }
    /**
     *
    ...
    public DTO save(DTO newEntity) {
        try{
            ...
            Logger.getLogger(GenericSqlRestServiceAbstractDto.class.getName()).log(Level.SEVERE, null, ex);
            ex.printStackTrace();
        }
        return null;
    }
    ...
    public DTO findById(ID id) {
        ...
        return repository.findById(id).map(mapper::toDto).orElseThrow(() -> {
            Logger.getLogger(GenericSqlRestServiceAbstractDto.class.getName()).log(Level.SEVERE, null, new EntityNotFoundException("Error accessing find entity  of type by id "));
                    ...
                    try {
                        ...
                        fieldList.forEach(oldField -> {
                            ...
                            try {
                                ...
                                Logger.getLogger(GenericSqlRestServiceAbstractDto.class.getName()).log(Level.SEVERE, null, e);
                            }
                        });
